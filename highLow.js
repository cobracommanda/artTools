...
//     }
//     if (
//       fill.typename != "SpotColor" &&
//       fill.typename != "RGBColor" &&
//       fill.typename != "CMYKColor"
//     ) {
//       throw (
//         "Sorry, " +
//         fill.typename +
//         " Objects are not currently supported.\nPlease convert the color to " +
//         colSpace +
//         "."
//       );
//     }
...
// Create a new swatch and place it in a new swatch folder
...
// Set swatch color (change values as needed)
newSwatch.color = new RGBColor();
newSwatch.color.red = 255; // Red value
newSwatch.color.green = 0; // Green value
newSwatch.color.blue = 0; // Blue value

// Create a new swatch folder
var swatchFolder = doc.swatchGroups.add();

// Rename the swatch folder (change name as needed)
swatchFolder.name = "New Swatch Folder";

// Add the newly created swatch to the swatch folder
swatchFolder.addSwatch(newSwatch);

// Display a success message
alert("Swatch created and placed in a new swatch folder.");
