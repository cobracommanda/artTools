...
# def generate_and_write_variations(color_name, crayola_cmyk, mode="analogic-complement", count=15):
#     cmyk_values = get_cmyk_values(color_name, crayola_cmyk)
...
#     save_to_python_file(kulers, f'{color_name}_{mode}.js')
  
# color_name = "Burnt Orange"
# generate_and_write_variations(color_name, crayola_cmyk)
